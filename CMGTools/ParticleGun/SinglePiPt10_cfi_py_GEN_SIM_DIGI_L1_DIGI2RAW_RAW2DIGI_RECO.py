...
# with command line options: Configuration/Generator/python/SinglePiPt10_cfi.py -s GEN,SIM,DIGI,L1,DIGI2RAW,RAW2DIGI,RECO --mc --conditions=auto:mc --eventcontent=FEVTDEBUG -n 2 --no_exec --fileout example.root
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/Generator/python/SinglePiPt10_cfi_py_GEN_SIM_DIGI_L1_DIGI2RAW_RAW2DIGI_RECO.py nevts:2000'),
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('SinglePiPt10_Evt200000.root'),
...
# generator = cms.PSet(
#        initialSeed = cms.untracked.uint32(369236915),
