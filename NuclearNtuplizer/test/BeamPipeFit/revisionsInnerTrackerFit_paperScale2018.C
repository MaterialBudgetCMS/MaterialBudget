...
void revisionsInnerTrackerFit_paperScale2018()
{
...
////Average over 3 adjacent sectors to smooth differences 
  ...
  if(FitObject == "BeamPipe"){
     Rmin = 1.8, Rmax = 3.7, RBGmin = 2.4, RBGmax = 3., RSmin = 2., RSmax = 2.4, RPlot = 4.0;
  ...
  if(FitObject == "PixelShield2Arcs"){
     ...
     Rmin = 3.0, Rmax = 5.0, RBGmin = 3.0, RBGmax = 3.55, RSmin = 3.55, RSmax = 4., RPlot = 8.;
     RangeEstimatorQuality = 0.1;
  ...
  //for ( int k = 0; k < 1; k++ ) //for for list of histograms to fit
  {
   ...
   // finish h_Draw
    ...
    if (FitObject == "BeamPipe" ){
       ...
       latex_circle.DrawLatex(-3.7, 3.6, "Data 2015");
       latex_circle.DrawLatex(-3.7, 3.2, "|z| < 25 cm");
    }
    if (FitObject == "PixelShield2Arcs" ){
        //latex_circle.DrawLatex(3., 5.5, "Data 2015");
        //latex_circle.DrawLatex(3., 4.8, "|z| < 25 cm");
       latex_circle.DrawLatex(4.5, 7.0, "Data 2015");
       latex_circle.DrawLatex(4.5, 6.3, "|z| < 25 cm");
    }
    if (FitObject == "PixelSupportEllipse" ){
