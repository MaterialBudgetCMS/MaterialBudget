...
//double Rmin = 3.0, Rmax = 4.1, RBGmin = 3.0, RBGmax = 3.5, RSmin = 3.5, RSmax = 3.9, RPlot = 4.1; 
double x0 = -0.00;// from 2015
double y0 = -0.095; // from 2015
double r0 = 3.73;  // from 2015

// r0          x0        y0
// 3.730 cm, -0.004 mm, 0-.76 mm 
// 3.728 cm, -0.43 mm, -1.10 mm
// no SetParLimit
// 3.731 cm, -0.10 mm, -0.66 mm
// 3.728 cm, -0.40 mm  -1.06 mm
// BG from one slice
// 3.733 cm, -0.41 mm, -1.15 mm
// 3.730 cm, -0.004 mm, -0.95 mm
...
void HistogramFitterNuclearInteractions_PixelShield()
{
  //gROOT->SetBatch(1);
  gROOT->ForceStyle();
...
*/
    ...
    fitter->SetParameter( 1, "x0",   x0, 0.01, -0.3, 0.3 ); // in cm
    fitter->SetParameter( 2, "y0",   y0, 0.01, -0.3, 0.3 ); // in cm
