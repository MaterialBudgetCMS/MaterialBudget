...
void InnerTrackerFit_MC()
{
  ...
  Double_t x0_PixelSupportMinus = 0.023;
  Double_t y0_PixelSupportMinus = -0.318;
  Double_t r0_PixelSupportMinus = 21.28;
  ...
  if(FitObject == "PixelShieldEllipse"){
     Rmin = 3.0, Rmax = 4.1, RBGmin = 2.6, RBGmax = 3.6, RSmin = 3.6, RSmax = 4.0, RPlot = 4.1;
     RangeEstimatorQuality = 0.1; 
     x_Sys = 0.01; // size of systematics in cm
     x0 = -0.029; // in cm
     y0 = -0.086; // in cm
  ...
  TFile* inputFile = TFile::Open("MC_10and100GeVpions.root");
  ...
  //for ( int k = -5; k < -4; k++ ) //for for list of histograms to fit
  {
    ...
    cPlots->Update();
    //cPlots->SaveAs(("Plots_MC/"+FitObject+"_Draw.pdf"));
    cPlots->SaveAs(("Plots_MC/"+FitObject+"_Draw.png"));

    h->Draw("LEGO");
    //cPlots->SaveAs(("Plots_MC/"+FitObject+"_Draw_LEGO.pdf"));
    cPlots->SaveAs(("Plots_MC/"+FitObject+"_Draw_LEGO.png"));
   ...
   hQuality->Sumw2();
    ...
    h->GetYaxis()->SetRangeUser(-RPlot, RPlot);
    h->Draw("LEGO");
    //cPlots->SaveAs(("Plots_MC/"+FitObject+"_FluxCorrection_LEGO.pdf"));
    cPlots->SaveAs(("Plots_MC/"+FitObject+"_FluxCorrection_LEGO.png"));
...
/*
      ...
      fn << "Plots_MC/"<<plotBg.c_str()<<"_BGUA" << "_" << phiSect<<".pdf";
      cPlots->SaveAs(fn.str().c_str());
      fn.str("");
      fn << "Plots_MC/"<<plotBg.c_str()<<"_BGUA" << "_" << phiSect<<".png";
      cPlots->SaveAs(fn.str().c_str());
*/
    ...
    cPlots->Update();
    //cPlots->SaveAs(("Plots_MC/"+FitObject+"_DrawBG.pdf"));
    cPlots->SaveAs(("Plots_MC/"+FitObject+"_DrawBG.png"));


    h0->Draw("LEGO");

    cPlots->Update();
    //cPlots->SaveAs(("Plots_MC/"+FitObject+"_DrawBG_LEGO.pdf"));
    cPlots->SaveAs(("Plots_MC/"+FitObject+"_DrawBG_LEGO.png"));
    //cPlots->Delete();
    //delete cPlots;
    ...
    for ( UInt_t phiSect = 0; phiSect < 40; phiSect ++ )
    {
      ...
      std::ostringstream fn;
      //fn << "Plots_MC/"<<plotBg<<"_BGUA_XCk" << "_" << phiSect<<".pdf";
      fn << "Plots_MC/"<<FitObject<<"_Slice_BGUA_XCk" << "_" << phiSect<<".pdf";
      //cPlots->SaveAs(fn.str().c_str());
      fn.str("");
      fn << "Plots_MC/"<<FitObject<<"_Slice_BGUA_XCk" << "_" << phiSect<<".png";
      cPlots->SaveAs(fn.str().c_str());
      //delete to avoid memory leak:
      //cPlots->Delete();
      //delete cPlots;
    ...
    cQuality->cd();
    hQuality->Draw("e");
    cQuality->Print("Plots_MC/Quality.png");
   ...
   TGraph* gr_arcPlus = gr_arc;
    ...
    cPlots->Update();
    //cPlots->SaveAs(("Plots_MC/"+FitObject+"_Fit.pdf"));
    cPlots->SaveAs(("Plots_MC/"+FitObject+"_Fit.png"));
    cPlots->SaveAs(("Plots_MC/"+FitObject+"_Fit.root"));

    TFile* f = new TFile(("Plots_MC/"+FitObject+"_Fit.root"), "UPDATE");
    ...
    if(FitObject != "PixelShieldEllipse" && FitObject != "PixelShieldEllipsePlus" && FitObject != "PixelShieldMinus" && FitObject != "PixelSupportMinus" && FitObject != "PixelSupportEllipse" && FitObject != "BeamPipeEllipse")
      ...
      bpAlt ->Draw("same");
      cPlots->Update();
      cPlots->SaveAs(("Plots_MC/"+FitObject+"_Fit_RhoPhi.png"));
      }
   ...
   if (flag_Sys == 1)
       ...
       // save plots
       cPlots->Update();
       cPlots->SaveAs(("Plots_MC/"+FitObject+"_Fit_RhoPhi_sysX.png"));
       ...
       // save
       cPlots->Update();
       cPlots->SaveAs(("Plots_MC/"+FitObject+"_Fit_RhoPhi_sysY.png"));
       ...
       // update and save
       cPlots->Update();
       cPlots->SaveAs(("Plots_MC/"+FitObject+"_Fit_RhoPhi_sysR.png"));
    }
    ...
    h->Draw("LEGO");
    cPlots->Update();
    //cPlots->SaveAs(("Plots_MC/"+FitObject+"_Fit_LEGO.pdf"));
    cPlots->SaveAs(("Plots_MC/"+FitObject+"_Fit_LEGO.png"));
    //cPlots->Delete();
    //delete cPlots;
    ...
    if (FitObject == "PixelSupportRails" || FitObject == "PixelSupportRailsPositive" || FitObject == "PixelSupportRailsNegative") {
       ...
       hYderivative ->Draw("e");
       cPlots->Update();
       cPlots->SaveAs("Plots_MC/yDerivative.png");

       hYderivative ->GetXaxis()->SetRangeUser(-Rmax, -Rmin);
       hYderivative ->GetXaxis()->SetRangeUser(Rmin, Rmax);
       hYderivative ->Draw("e");
       cPlots->Update();
       cPlots->SaveAs("Plots_MC/yDerivativeTop.png");

       hYderivative ->GetXaxis()->SetRangeUser(-Rmax, -Rmin);
       hYderivative ->Draw("e");
       cPlots->Update();
       cPlots->SaveAs("Plots_MC/yDerivativeBottom.png");

       hYderivative2D->Draw("COLZ");
       cPlots->Update();
       cPlots->SaveAs("Plots_MC/yDerivative2D.png");
       ...
       f2Bottom ->Draw("same");
       cPlots->Update();
       cPlots->SaveAs("Plots_MC/yDerivative2DBottom.png");
       ...
       //tbox ->Draw("same");
       cPlots->Update();
       cPlots->SaveAs("Plots_MC/yDerivative2DTop.png");

       hXderivative2D->Draw("COLZ");
       cPlots->Update();
       cPlots->SaveAs("Plots_MC/xDerivative2D.png");
       ...
       cPlots->Update();
       cPlots->SaveAs("Plots_MC/xDerivative2DBottom.png");

       hXderivative2D ->GetYaxis()->SetRangeUser(Rmin, RSmax);
       hXderivative2D->Draw("COLZ");
       cPlots->Update();
       cPlots->SaveAs("Plots_MC/xDerivative2DTop.png");
    ...
    // save
    cPlots->Update();
    //cPlots->SaveAs(("Plots_MC/"+FitObject+"_Fit_COLZ.pdf"));
    cPlots->SaveAs(("Plots_MC/"+FitObject+"_Fit_COLZ.png"));
  ...
  pad3->Update();
  //cPlots->SaveAs("Plots_MC/FitResults.pdf");
  cPlots->SaveAs("Plots_MC/FitResults.png");
