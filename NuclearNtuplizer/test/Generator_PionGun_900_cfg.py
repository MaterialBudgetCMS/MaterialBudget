...
# with command line options: SinglePiPt10_pythia8_cfi.py -s GEN,SIM,DIGI:pdigi_valid,L1,DIGI2RAW,RAW2DIGI,RECO --conditions=90X_upgrade2017_realistic_v20 --eventcontent=FEVTDEBUG -n 2
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('SinglePiPt10_pythia8_cfi_py_GEN_SIM_DIGI_L1_DIGI2RAW_RAW2DIGI_RECO.root'),
