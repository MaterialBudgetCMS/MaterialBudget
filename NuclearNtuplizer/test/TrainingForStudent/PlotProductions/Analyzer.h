...
// Mon Jun 19 16:38:29 2017 by ROOT version 6.08/04
// from TTree NuclearInteractionsTree/NuclearInteractionsTree
// found on file: Ntuple_MC_10GeV_900.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Ntuple_MC_10GeV_900.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Ntuple_MC_10GeV_900.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("Ntuple_MC_10GeV_900.root:/MyNtupleMaking");
