#ifndef NtupleReader_Training_h
#define NtupleReader_Training_h
...
class NtupleReader_Training
{
  public :
    NtupleReader_Training( const std::string fileList, const Long64_t maxEvents = 0 );
    ~NtupleReader_Training();
    void beginJob();
    void analyze();
    void endJob();
