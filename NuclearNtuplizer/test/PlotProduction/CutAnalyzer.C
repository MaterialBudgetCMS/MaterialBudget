...
CutAnalyzer::CutAnalyzer( const std::string fileList, const Long64_t maxEvents )
{
  ...
  outputFile = new TFile( "prova_Cuts2015.root", "RECREATE" );
}
...
void CutAnalyzer::beginJob()
{
  ...
  hMC_TrkV_momentumOut_pt_Barrel_MaxCut = new TH1D( "hMC_TrkV_momentumOut_pt_Barrel_MaxCut", "N.I. in Tracker", 100, 0., 110. );
  hMC_TrkV_momentumOut_pt_Barrel_MaxCut->Sumw2();
  hMC_TrkV_momentumOut_pt_Forward_MaxCut = new TH1D( "hMC_TrkV_momentumOut_pt_Forward_MaxCut", "N.I. in Tracker", 100, 0., 110. );
