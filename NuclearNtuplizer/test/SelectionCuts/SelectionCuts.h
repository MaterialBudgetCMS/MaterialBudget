...
public :
   ...
   SelectionCuts(TTree *tree=0);
   virtual ~SelectionCuts();
...
#ifdef SelectionCuts_cxx
SelectionCuts::SelectionCuts(TTree *tree) : fChain(0) 
{
...
Int_t SelectionCuts::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t SelectionCuts::LoadTree(Long64_t entry)
{
...
void SelectionCuts::Init(TTree *tree)
{
...
void SelectionCuts::Show(Long64_t entry)
{
...
Int_t SelectionCuts::Cut(Long64_t entry)
{
