...
pyCfgParams = ['outputFile=Run2017E.root']

config.section_('General')
config.General.transferLogs = True
config.General.workArea     = 'projects_Run2017E'  # Make sure you set this parameter
...
config.JobType.outputFiles      = ['Run2017E.root']
...
config.Data.lumiMask = 'https://cms-service-dqm.web.cern.ch/cms-service-dqm/CAF/certification/Collisions17/13TeV/PromptReco/Cert_294927-305636_13TeV_PromptReco_Collisions17_JSON.txt'
config.Data.outLFNDirBase = '/store/group/dpg_tracker_strip/tracker/MaterialBudget/NI/Run2017E_SingleMu'
# to run on Tier1
