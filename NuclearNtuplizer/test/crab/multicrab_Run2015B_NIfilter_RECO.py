...
pyCfgParams = ['outputFile=Run2015B_RECO.root']

config.section_('General')
config.General.transferLogs = True
config.General.workArea     = 'crab_projects_Run2015B_RECO_v2'  # Make sure you set this parameter
...
config.JobType.outputFiles      = ['Run2015B_RECO.root']
