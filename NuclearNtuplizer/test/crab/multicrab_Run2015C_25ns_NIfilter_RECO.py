...
pyCfgParams = ['outputFile=Run2015C_25ns_RECO.root']

config.section_('General')
config.General.transferLogs = True
config.General.workArea     = 'crab_projects_Run2015C_25ns_RECO_v2'  # Make sure you set this parameter

config.section_('JobType')
config.JobType.pluginName       = 'Analysis'
#config.JobType.pluginName       = 'PrivateMC'
config.JobType.psetName         = 'NtupleMakerWithReReco_Run2015B_NIfilter_cfg.py'
config.JobType.maxJobRuntimeMin = 2800
config.JobType.outputFiles      = ['Run2015C_25ns_RECO.root']
...
config.Data.outLFNDirBase = '/store/group/phys_higgs/cmshww/kropiv/NI/RECO/NIfilter'
