...
# Schedule definition
#process.schedule = cms.Schedule(process.raw2digi_step,process.reconstruction_step,process.pathALCARECOSiStripCalMinBias,process.endjob_step,process.RECOoutput_step,process.ALCARECOStreamSiStripCalMinBiasOutPath,process.ana_step)
process.schedule = cms.Schedule(process.raw2digi_step,process.reconstruction_step,process.endjob_step,process.ana_step)
