...
pyCfgParams = ['outputFile=Run2017B.root']

config.section_('General')
config.General.transferLogs = True
config.General.workArea     = 'projects_Run2017B'  # Make sure you set this parameter

config.section_('JobType')
config.JobType.pluginName       = 'Analysis'
#config.JobType.pluginName       = 'PrivateMC'
config.JobType.psetName         = 'NtupleMaker_Run2017B_930_cfg.py'
config.JobType.maxJobRuntimeMin = 2750
config.JobType.outputFiles      = ['Run2017B.root']
...
config.Data.lumiMask = 'https://cms-service-dqm.web.cern.ch/cms-service-dqm/CAF/certification/Collisions17/13TeV/PromptReco/Cert_294927-299042_13TeV_PromptReco_Collisions17_JSON.txt'
#config.Data.outLFNDirBase = '/store/group/phys_higgs/cmshww/kropiv/NI/RECO'
config.Data.outLFNDirBase = '/store/group/dpg_tracker_strip/tracker/MaterialBudget/NI/Run2017B_SingleMu'
# to run on Tier1
