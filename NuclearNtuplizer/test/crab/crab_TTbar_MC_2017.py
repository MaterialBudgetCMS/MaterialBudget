...
pyCfgParams = ['outputFile=TTbar_2017.root']
...
config.JobType.outputFiles      = ['TTbar_2017.root']
...
config.Data.outLFNDirBase = '/store/group/dpg_tracker_strip/tracker/MaterialBudget/NI/TTbar_2017'
