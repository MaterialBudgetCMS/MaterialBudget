...
pyCfgParams = ['outputFile=RunMinBias.root']
...
config.JobType.outputFiles      = ['RunMinBias.root']
...
config.Data.totalUnits    = 200 # total number of files, lumi sec. or events depending of "splitting"
