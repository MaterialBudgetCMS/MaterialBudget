...
config.General.workArea     = 'projects_DYFallRun2017'  # Make sure you set this parameter
...
config.Data.outLFNDirBase = '/store/group/dpg_tracker_strip/tracker/MaterialBudget/NI/DYFall2017FlatPU'
# to run on Tier1
