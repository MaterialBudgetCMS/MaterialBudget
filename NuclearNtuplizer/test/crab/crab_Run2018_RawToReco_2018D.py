...
config.General.workArea     = 'projects_Run2018_v2'  # Make sure you set this parameter

config.section_('JobType')
config.JobType.pluginName       = 'Analysis'
#config.JobType.pluginName       = 'PrivateMC'
config.JobType.psetName         = 'NtupleMaker_Run2018_RawtoReco_cfg.py'
...
config.Data.unitsPerJob   = 10 # number of files, lumi sec. or events depending of "splitting"
