#ifndef NtupleReaderNuclearInteractions_MaterialBudget_h
#define NtupleReaderNuclearInteractions_MaterialBudget_h
...
class NtupleReaderNuclearInteractions_MaterialBudget
{
  public :
    NtupleReaderNuclearInteractions_MaterialBudget( const std::string fileList, const Long64_t maxEvents = 0 );
    ~NtupleReaderNuclearInteractions_MaterialBudget();
    void beginJob();
    void analyze();
    void endJob();
...
*/
    TH2D* hPFDVTracks_dxy_PFDV_Rho;
    TH2D* hPFDVTracks_DR_PFDV_Rho;
